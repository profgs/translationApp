...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { active: @phrase.active, spanish: @phrase.spanish, translation: @phrase.translation } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { active: @phrase.active, spanish: @phrase.spanish, translation: @phrase.translation } }
